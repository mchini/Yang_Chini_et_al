        ...
        if opt.showMM == 6
            ...
            for qq = 1:3
                ...
                yLoc =  repmat(...
                    ...
                    [4 1]);
                % imperfect fix by Mattia (ugly but works almost always)
                if nnz(yLoc) == 0
                    md(iData,qq,1) = floor(md(iData,qq,1));
                    yLoc =  repmat(...
                        any(yArray>md(iData,qq,1),1) & ...
                        any(yArray<=md(iData,qq,1),1), [4 1]);
                end
                if nnz(yLoc) == 0
                    md(iData,qq,1) = md(iData,qq,1) + 1;
                    yLoc =  repmat(...
                        any(yArray>md(iData,qq,1),1) & ...
                        any(yArray<=md(iData,qq,1),1), [4 1]);
                end

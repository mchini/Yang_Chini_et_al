...
path.append(r'C:/Users/axelf/Documents/OASIS-master')
...
animals =['TS_C_ISO_8235','TS_C_ISO_8237','TS_C_ISO_8238']

database_path = 'Q:/Andrey/DataAnalysis/meta_recordings_transition_state.xlsx'
...
for r in rec:
    ...
    if (animal=='TS_C_ISO_F0'):
        threshold = 115   # 
    if (animal=='TS_C_ISO_F1'):
        threshold = 75   #
    if (animal=='TS_C_ISO_M1'):
        threshold = 50    #
    if (animal=='TS_C_ISO_M0'):
        threshold = 160   #  old 130
        
    if (animal=='TS_C_ISO_51'):
        threshold = 100

    if (animal=='TS_C_ISO_8235'):
         threshold = 130
    if (animal=='TS_C_ISO_8237'):
         threshold = 130
    if (animal=='TS_C_ISO_8238'):
         threshold = 100
...
df_estimators.to_pickle("./df_estimators_TS_C_ISO_8235_8237_8238_n_peaks_baseline.pkl") 
df_corrs.to_pickle("./df_corrs_TS_C_ISO_8235_8237_8238_n_peaks_baseline.pkl")

################################################################################
################################################################################

animals =['TS_C_KETA_8235','TS_C_KETA_8237','TS_C_KETA_8238']
...
for r in rec:
    ...
    if (animal=='TS_KETA_F0'):
        threshold = 70   ### recording 70
    
    if (animal=='TS_C_KETA_F0'):
        threshold = 80   ### recording 70
    if (animal=='TS_C_KETA_F1'):
        threshold = 35   # 35
    if (animal=='TS_C_KETA_M1'):
        threshold = 65   # 60
    if (animal=='TS_C_KETA_M3'):
        threshold = 90    # 90
        
    if (animal=='TS_C_KETA_8235'):
         threshold = 240
    if (animal=='TS_C_KETA_8237'):
         threshold = 240  
    if (animal=='TS_C_KETA_8238'):
         threshold = 220
...
df_estimators.to_pickle("./df_estimators_TS_C_KETA_8235_8237_8238_n_peaks_baseline.pkl") 
df_corrs.to_pickle("./df_corrs_TS_C_KETA_8235_8237_8238_n_peaks_baseline.pkl") 

################################################################################
################################################################################

animals =['TS_C_MMF_F0','TS_C_MMF_M0']
...
for r in rec:
    ...
    if (animal=='TS_C_MMF_F0'):
        threshold = 110   ### Doubled to match F0 (see n_peaks vs threshold plot)
    if (animal=='TS_C_MMF_F1'):
        threshold = 50
    if (animal=='TS_C_MMF_M1'):
        threshold = 45
    if (animal=='TS_C_MMF_M0'):
        threshold = 200
        
        
    if (animal=='TS_C_MMF_8235'):
         threshold = 220
    if (animal=='TS_C_MMF_8237'):
         threshold = 160
    if (animal=='TS_C_MMF_8238'):
         threshold = 250
...
df_estimators.to_pickle("./df_estimators_TS_C_MMF_8235_8237_8238_n_peaks_baseline.pkl")
df_corrs.to_pickle("./df_corrs_TS_C_MMF_8235_8237_8238_n_peaks_baseline.pkl")
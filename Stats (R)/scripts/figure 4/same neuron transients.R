...
data <- read.xlsx("E:/Calcium Imaging/stats/datasets/transients/all_conds.xlsx")
...
decay <- data$decay
height <- data$height
excel_file <- "E:/Calcium Imaging/stats/stats summary/figure4.xlsx"
wb <- createWorkbook()
...
data <- read.xlsx("E:/Calcium Imaging/stats/datasets/transients/iso_awa.xlsx")
condition <- factor(data$condition)
IDneurons <- factor(data$IDneurons)
mouse <- factor(data$mouse)
n_peaks <- data$n_peaks
...
data <- read.xlsx("E:/Calcium Imaging/stats/datasets/transients/fenta_awa.xlsx")
condition <- factor(data$condition)
IDneurons <- factor(data$IDneurons)
mouse <- factor(data$mouse)
n_peaks <- data$n_peaks
...
data <- read.xlsx("E:/Calcium Imaging/stats/datasets/transients/keta_awa.xlsx")
condition <- factor(data$condition)
IDneurons <- factor(data$IDneurons)
mouse <- factor(data$mouse)
n_peaks <- data$n_peaks
...
data <- read.xlsx("E:/Calcium Imaging/stats/datasets/transients/iso_fenta.xlsx")
condition <- factor(data$condition)
IDneurons <- factor(data$IDneurons)
mouse <- factor(data$mouse)
n_peaks <- data$n_peaks
...
data <- read.xlsx("E:/Calcium Imaging/stats/datasets/transients/iso_keta.xlsx")
condition <- factor(data$condition)
IDneurons <- factor(data$IDneurons)
mouse <- factor(data$mouse)
n_peaks <- data$n_peaks
...
data <- read.xlsx("E:/Calcium Imaging/stats/datasets/transients/keta_fenta.xlsx")
condition <- factor(data$condition)
IDneurons <- factor(data$IDneurons)
mouse <- factor(data$mouse)
n_peaks <- data$n_peaks
